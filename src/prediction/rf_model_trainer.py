...
class rf_ModelTrainer(
    ...
    def train_model(
        ...
        """
        Trains a Random Frorest Regressor model.

        Returns:
            - tuple[RandomFrorestRegressor, RandomFrorestRegressor, RandomFrorestRegressor]: The trained GPR model.
